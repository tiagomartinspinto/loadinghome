...
- Reduced the top application record to six fields and the residence verification record to five fields.
...
- Restored the compact museum-form layout proportions after the monochrome pass: 1080px page width, 15px base type, and a balanced application record.
...
- Checked the compact monochrome layout in the browser for 1080px page width, 15px base type, three application-record columns, no horizontal overflow, normal mode, exhibition mode, and no console errors.
- Checked the reduced-record pass for six top application fields and five residence verification fields.
