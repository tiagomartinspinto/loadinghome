...
`Loading Home: 97%` is a minimalist web artwork about immigration as a permanent state of almost-arrival. The page keeps trying to load home, verify residence, translate memory, and confirm belonging, but the process never completes.
